...
public class SpringReturnController {
	Logger logger = LogManager.getLogger(SpringReturnController.class);
	
	// return 형 String
	@RequestMapping("viewJsp_1_stringTest_find")
	public String returnStringTest(Model m){
		// return 형 객체
		logger.info("SpringReturnController :: returnStringTest(Model m) 함수 진입 >>> : ");
		
		// 데이터는 m.addAttibute(key, value);
	...
	public ModelAndView returnModelAndViewTest(){
		logger.info("SpringReturnController :: returnModelAndViewTest() 함수 진입 >>> : ");
