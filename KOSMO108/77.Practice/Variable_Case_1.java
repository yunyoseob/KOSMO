...
// ArrayList에서 <>를 하지 않으면
/*
Complie Issue

Note: Variable_Case_1.java uses unchecked or unsafe operations.
Note: Recompile with -Xlint:unchecked for details.

가 출력된다. (StackoverFlow에 따르면, error가 아니라고 한다.
...
public class Variable_Case_1{
	...
	public static void main(String args[]) {
		...
		*/
		...
		aList_1.add(c);
		aList_1.add(vo);
		System.out.println(aList_1.size());
