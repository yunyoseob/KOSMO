...
$(document).ready(function(){
	...
	$(document).on("click", "#getbtn", function(){
		...
		$("#formData").attr({
			"action":"formdata_get_servlet.yys",
			"method":"GET",
	...
	$(document).on("click", "#get_spring_btn", function(){
		...
		$("#formData").attr({
			"action":"formdata_get_spring.yys",
			"method":"GET",
			"enctype":"application/x-www-form-urlencoded"
		}).submit();				
	});
	...
	$(document).on("click", "#post_spring_btn", function(){
		...
		$("#formData").attr({
			"action":"formdata_post_spring.yys",
			"method":"POST",
			"enctype":"application/x-www-form-urlencoded"
		}).submit();					
	});
	...
	$(document).on("click", "#post_spring_btn_111", function(){
		...
		$("#formData").attr({
			"action":"formdata_post_valueobject.yys",
			"method":"POST",
			"enctype":"application/x-www-form-urlencoded"
		}).submit();			
	});
...
<%
	...
	logger.info("formdata_return.jsp 페이지 입니당 >>> : ");
