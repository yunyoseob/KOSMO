...
public class KosmoBoardController {
	...
	// 게시판 수정 (나중에)
	@RequestMapping(value="kosmoBoardUpdate", method=RequestMethod.GET)
	public String kosmoBoardUpdate(KosmoBoardVO bvo, Model model){
		logger.info("KosmoBoardController :: kosmoBoardUpdate 함수 진입 >>> : ");
		return "board/kosmoBoardSelectAll";
	}
